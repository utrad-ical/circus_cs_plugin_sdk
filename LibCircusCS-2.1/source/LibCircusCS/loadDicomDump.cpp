...
void
CircusCS_DeleteDcmDumpData(CircusCS_DCMDUMPDATA* dumpData)
{
	dumpData->data->~CSimpleIniTempl();
	//delete dumpData->data;
	free(dumpData);
}


CircusCS_DCMDUMPDATA*
CircusCS_LoadDcmDumpFile(char* fileName)
{
...
std::string
CircusCS_GetDcmTagElementOfDumpData(CircusCS_DCMDUMPDATA* dumpData,
									int sliceNum,
...
CircusCS_NewBasicDcmTagValues(char* fileName, int sliceNum)
{
	...
	buf = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_StudyDate);
	strcpy(ret->studyDate, buf.c_str());

	buf = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_StudyTime);
	strcpy(ret->studyTime, buf.c_str());

	buf = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_SeriesDate);
	strcpy(ret->seriesDate, buf.c_str());

	buf = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_SeriesTime);
...
int
CircusCS_GetModalityOfDumpData(CircusCS_DCMDUMPDATA* dumpData, char* modality, int sliceNum)
{
	std::string buffer;

	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_Modality);
...
int
CircusCS_GetPatientSexOfDumpData(CircusCS_DCMDUMPDATA* dumpData, char* sex, int sliceNum)
{
	std::string buffer;

	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_PatientSex);
...
int
CircusCS_GetPatientAgeOfDumpData(CircusCS_DCMDUMPDATA* dumpData, int* age, int sliceNum)
{
	*age = 0;
	std::string buffer;

	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_PatientAge);
...
int
CircusCS_GetPatientSizeOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* size, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_PatientSize);
...
int
CircusCS_GetPatientWeightOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* weight, int sliceNum)
{
	std::string buffer;

	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_PatientWeight);
...
int
CircusCS_GetImageNumberOfDumpData(CircusCS_DCMDUMPDATA* dumpData, int* imageNum, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_InstanceNumber);
...
int
CircusCS_GetAcquisitionNumberOfDumpData(CircusCS_DCMDUMPDATA* dumpData, int* acquisitionNum, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_AcquisitionNumber);
...
CircusCS_GetMatrixSizeOfDumpData(CircusCS_DCMDUMPDATA* dumpData, CircusCS_INTSIZE2D* matrixSize, int sliceNum)
{
	...
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_Columns);

	if(buffer.compare("") == 0)	return -1;

	matrixSize->width = atoi(buffer.c_str());	

	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_Rows);
...
int
CircusCS_GetFieldOfViewOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* fov, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_ReconstructionDiameter);
...
int
CircusCS_GetSliceThicknessOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* thickness, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_SliceThickness);
...
int
CircusCS_GetDistanceBetweenSlicesOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* dbs, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_SpacingBetweenSlices);
...
int
CircusCS_GetSliceLocationOfDumpData(CircusCS_DCMDUMPDATA* dumpData, float* sliceLoc, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_SliceLocation);
...
CircusCS_GetPixelSpacingOfDumpData(CircusCS_DCMDUMPDATA* dumpData, CircusCS_SIZE2D* pixelSpacing, int sliceNum)
{
	...
	strcpy(buffer, CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_PixelSpacing).c_str());
...
int
CircusCS_GetRescaleInterceptOfDumpData(CircusCS_DCMDUMPDATA* dumpData, double* intercept, int sliceNum)
{
	std::string buffer;
	*intercept = 0.0;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_RescaleIntercept);
...
int
CircusCS_GetRescaleSlopeOfDumpData(CircusCS_DCMDUMPDATA* dumpData, double* slope, int sliceNum)
{
	std::string buffer;
	*slope = 1.0;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_RescaleSlope);
...
int
CircusCS_GetRadionuclideTotalDoseOfDumpData(CircusCS_DCMDUMPDATA* dumpData, double* totalDose, int sliceNum)
{
	std::string buffer;
	
	buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, TAGSTR_RadionuclideTotalDose);
	...
	if(buffer.compare("") == 0)
	{
		...
		buffer = CircusCS_GetDcmTagElementOfDumpDataFromTagStr(dumpData, sliceNum, tagStr);
...
base64Decode(const char* src)
{
	...
	{       
		ind1 = *(src + i + 0) == '=' ? 0 : strchr(BASE64, *(src + i + 0)) - BASE64; // same as codetovalue
		ind2 = *(src + i + 1) == '=' ? 0 : strchr(BASE64, *(src + i + 1)) - BASE64;
		ind3 = *(src + i + 2) == '=' ? 0 : strchr(BASE64, *(src + i + 2)) - BASE64;
		ind4 = *(src + i + 3) == '=' ? 0 : strchr(BASE64, *(src + i + 3)) - BASE64;
